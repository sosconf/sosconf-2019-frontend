    ...
    render() {
        ...
        if (this.props.language == 'zh') {
            ...
            news = <div className="sosconf-home__news--container">
                    ...
                    <div className="sosconf-home__news--hr"></div>
                    <div className="sosconf-home__news--content">
                        <p>Student Open Source Conference (sosconf) is the very first student-held, student-centered international conference focusing on open source. It will be a great opportunity for students around the world to gather, connect and learn from each other. For companies and organizations, it will be a chance to show their commitment to open source and to search for student talents. The conference will be held in Los Angeles in August, with mini-events and talks focusing on different technology fields in a two-day span. Students of any education levels around the world are welcome to participate as audience, volunteers or speakers, with an opportunity of obtaining travel reimbursement. <b>Information on becoming volunteers, speakers, and sponsors can be found below.</b></p>
