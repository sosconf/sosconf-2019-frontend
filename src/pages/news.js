        ...
        if (this.props.language == 'zh') {
            ...
            news = <div className="sosconf-home__news--container">
                    ...
                    <div className="sosconf-home__news--content">
                        ...
                        {/* <h3>Promoting Student Open-Source Community</h3> */}
                        <p>“sosconf is brought to students, by students,” said Ivan, an undergraduate student at University of Southern California and Director of sosconf 2019 Committee. Only students from all levels of education are eligible to be speakers and volunteers, but attendee qualification is open to everyone. Reimbursements will be provided to all speakers and volunteers with outstanding work, and may be extended to a wider range of participants if enough funding is available. The sosconf 2019 committee is dedicated to making the conference accessible to all students in the world.</p>
                        ...
                        {/* <h3>An Experiment</h3> */}
                        <p>“The conference itself is an open-source project,” said Ivan, “and we welcome students or sponsors who identify with our goals to join us to make this happen.” Contact information and event details are now available on sosconf’s official website, https://sosconf.org/.</p>
                        {/* <ul>
                            <li><a href="https://fb.com/sosconf">Facebook：https://fb.com/sosconf</a></li>
                            <li><a href="https://twitter.com/sosconf">Twitter：https://twitter.com/sosconf</a></li>
                            <li><a href="https://t.me/sosconf">Telegram：https://t.me/sosconf</a></li>
