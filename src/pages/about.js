            ...
            return (
                <div>
                    ...
                    body={(
                        <div className="sosconf__about-card-content">
                            <p>
                            Student Open Source Conference(sosconf) 2019 is collaborated on by Opening Source Org and Society of Opening Source SC. Opening Source Org is an international group of student enthusiasts who make great contributions to open source. SOSSC is a newborn student organization at USC. It is brought to students by students. sosconf is the very first student-held, student-centered international conference focusing on open source. It will be a great opportunity for students around the world to gather, connect and learn from each other. For companies and organizations, it will be a chance to show their commitment to open source and to search for student talents. The conference will be held at University of Southern California in Los Angeles on September 1, with mini-events and talks focusing on different technology fields. Students of any education levels around the world are welcome to participate as audience, volunteers or speakers, with an opportunity of obtaining travel reimbursement.
                            </p>
                            <a className="sosconf-home__button--black sosconf-card__button--green">
                                <span><a href="mailto:hi@sosconf.org">Contact us</a></span>
                            </a>
